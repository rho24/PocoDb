...
namespace PocoDb.Specs.Persistence.SqlServer
{
    public static class SQLCEEntityFramework
    {
        public static void Start() {
            ...
            DbDatabase.SetInitializer(new DropCreateCeDatabaseAlways<SqlServerCommitStore.Context>());
        }
    }
        ...
        protected static DbContext ReplaceSqlCeConnection(DbContext context) {
            if (context.Database.Connection is SqlCeConnection) {
                ...
                if (!String.IsNullOrWhiteSpace(builder.DataSource)) {
                    ...
                    return new SqlServerCommitStore.Context(builder.ConnectionString);
                }
            }
            return context;
        }

        static string ReplaceDataDirectory(string inputString) {
